  ...
  return (
    <>
      ...
      <div style={{ position: "absolute", top: 130, left: 150 }}>
        ...
        <div style={{ margin: 20 }}>
          We know that n(A⋃B) = n(A) + n(B) – n(A⋂B), therefore n(A⋃B) ={" "}
          {AunionB}
        </div>
        <div className="row">
          <p>
        ...
        <div style={{ margin: 20 }}>
          We know that n(A⋃B⋃C) = n(A) + n(B) + n(C) – n(A⋂B) – n(A⋂C) – n(B⋂C)
          + n(A⋂B⋂C), therefore n(A⋃B⋃C) = {AunionBunionC}
        </div>
      </div>
    </>
  );
